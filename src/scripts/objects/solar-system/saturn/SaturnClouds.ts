// src/scripts/objects/solar-system/saturn/SaturnClouds.ts
...
/**
 * Saturn cloud layer — triforge node-graph port of the original
 ...
 *
 * Same 8k_saturn texture as the surface, panned independently (UvPan) to
 ...
 */
export function buildSaturnCloudMaterial(cloudTexture: THREE.Texture): PannableMaterial {
